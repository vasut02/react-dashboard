...
const App = () => {
    ...
    return (
        <Box sx={{ mr: 4, borderRadius: "10px",height:{md:"100%", lg:"80%"}, boxShadow: "2px 2px 4px 0 rgba(15, 10, 15, 0.5), -2px -2px 4px 0 rgba(41, 82, 113, 0.5), inset 0 1px 250px 0 rgba(5, 16, 24, 0.1)", backgroundColor: "rgba(9, 24, 35, 0.05)", color: "white", p: 2 }}>
